...
if __name__ == "__main__":
    ...
    parser.add_argument("--wandb_checkpoint", default=None, type=str, help="USER/PROJECT/MODEL-RUN_ID:VERSION, load checkpoint from wandb")
